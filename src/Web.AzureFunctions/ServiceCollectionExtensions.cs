...
namespace Web.AzureFunctions
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// </summary>
        public static ConfigurationBuilder AddAzureFunctionsConfiguration<TStartup>(this ConfigurationBuilder configurationBuilder, bool isAddUserSecrets = false) where TStartup : class
        {
