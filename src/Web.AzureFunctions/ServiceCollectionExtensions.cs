...
namespace Web.AzureFunctions
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// </summary>
        public static ConfigurationBuilder AddAzureFunctionsConfiguration<TStartup>(this ConfigurationBuilder configurationBuilder, bool isUserSecretsOptional = true) where TStartup : class
        {
            if (new AzureFunctionsConfiguration().IsLocal)
            {
                configurationBuilder.AddJsonFile("appsettings.Local.json", false, true);
                configurationBuilder.AddUserSecrets<TStartup>(isUserSecretsOptional);
            }
